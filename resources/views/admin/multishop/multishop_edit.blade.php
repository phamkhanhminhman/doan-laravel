...
<div class="right_col" role="main">
 ...
 <div class="row">
    <div class="col-md-9 col-sm-9 col-xs-9">
      <div class="x_panel">
        <div class="x_content">
          <form  action="{{url('admin/multishop-update')}}" class="form-horizontal" method="post" enctype="multipart/form-data">
            @csrf
            @foreach ($multishop as $k)   
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text"  name="secretID"  class="form-control  col-md-7 col-xs-12" value="{{$k->secretID}}" placeholder="Nhập Secret ID">
              </div> -->
            </div>
             <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text"  name="partnerID"  class="form-control col-md-7 col-xs-12" value="{{$k->partnerID}}"placeholder="Nhập Partner ID">
              </div> -->
            </div>
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text"  name="shopChannel"  class="form-control col-md-7 col-xs-12" value="{{$k->shopChannel}}"placeholder="Nhập Tên San">
              </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" name="shopName"  class="form-control col-md-7 col-xs-12" value="{{$k->shopName}}"placeholder="Nhập Tên Shop">
            </div>
          </div>
           @endforeach 
        </form>
